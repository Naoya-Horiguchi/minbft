...
var (
	...
	// These data structures are shared between goroutines running
	// simulated nodes, so we need mutual exclusion.
	// These locks could be more fine-grained, but it should be
	// fine for simple scenarios with a few nodes.
